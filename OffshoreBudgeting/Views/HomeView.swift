...
struct HomeView: View {
    ...
    var body: some View {
        ...
        .toolbar {
            ToolbarItemGroup(placement: .navigationBarTrailing) {
                ...
                calendarToolbarMenu()
                    .padding(.leading, HomeToolbarMetrics.itemSpacing)
    ...
    private func calendarToolbarMenu() -> some View {
        let menu = Menu {
            ...
            toolbarIconLabel(systemImage: "calendar")
    ...
    private func optionsToolbarMenu(summary: BudgetSummary) -> some View {
        Menu {
            ...
            toolbarIconLabel(systemImage: "ellipsis", symbolVariants: .none)
        }
        .modifier(HideMenuIndicatorIfPossible())
    ...
    @ViewBuilder
    private func toolbarIconLabel(systemImage: String, symbolVariants: SymbolVariants? = nil) -> some View {
        if capabilities.supportsOS26Translucency, #available(iOS 26.0, macOS 26.0, macCatalyst 26.0, *) {
...
private enum HomeToolbarMetrics {
    static let itemSpacing: CGFloat = DS.Spacing.s
}

// MARK: - Legacy Toolbar Icon
private struct LegacyToolbarIconLabel: View {
